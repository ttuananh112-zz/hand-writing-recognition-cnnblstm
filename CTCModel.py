...
class CTCModel:
    ...
    def compile(self, optimizer):
        ...
        # Compile models
        self.model_train.compile(loss={'CTCloss': lambda yt, yp: yp}, optimizer=optimizer, metrics=['accuracy'])
        self.model_pred.compile(loss={'CTCdecode': lambda yt, yp: yp}, optimizer=optimizer, metrics=['accuracy'])
        self.model_eval.compile(loss={'CTCanalysis': lambda yt, yp: yp}, optimizer=optimizer, metrics=['accuracy'])
